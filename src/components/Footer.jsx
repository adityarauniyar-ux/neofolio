...
const Footer = () => {
  ...
  const handleReportBug = () => {
    window.location.href = 'mailto:adityarauniyar.tech@gmail.com?subject=Bug/Suggestion for neofolio.vercel.app';
  };
            ...
            >
              <div className="flex flex-col items-center md:items-start">
                ...
                <span className="flex items-center gap-2 text-sm text-gray-400 mt-1">
                  ...
                  <span className="bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent">
                    ♥️
                  </span> by <a href="#" target="_blank" className="text-gray-400 hover:underline">Aditya Rauniyar</a>
                </span>
              </div>
            </motion.div>
